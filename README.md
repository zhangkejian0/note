...
3. [fluro路由,fluro在flutterDemo中的使用,fluro的传参,maintainState的使用](https://github.com/zhangkejian0/flutterDemo/blob/main/lib/utils/README_Router.md)
4. [flutter中组件间的事件传递，手写一个EventBus](https://github.com/zhangkejian0/flutterDemo/blob/main/lib/utils/eventBus.dart)